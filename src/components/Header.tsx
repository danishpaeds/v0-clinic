        ...
        <div className="flex h-24 lg:h-28 items-center justify-between gap-4">
          ...
          <Link href="/" className="flex items-center gap-4 hover:opacity-90 transition-opacity">
            ...
            <div className="hidden sm:flex flex-col">
              <span className="text-xl lg:text-2xl font-light text-[#66257B] tracking-wide">Dr Vrushni Bhuta</span>
              <span className="text-[10px] lg:text-xs text-[#F29038] tracking-[0.3em] uppercase font-light">
          ...
          <nav className="hidden lg:flex items-center gap-8">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="text-sm font-light text-gray-700 hover:text-[#66257B] transition-colors tracking-wide relative group"
              >
                {link.label}
                <span className="absolute -bottom-1 left-0 w-0 h-px bg-gradient-to-r from-[#66257B] to-[#F29038] group-hover:w-full transition-all duration-300"></span>
              </Link>
            ))}
          </nav>
          ...
          <div className="hidden lg:flex items-center gap-6">
            <div className="flex items-center gap-4">
              <a
                ...
                className="text-gray-500 hover:text-[#66257B] transition-colors"
              >
            ...
            <Button
              asChild
              className="bg-[#66257B] hover:bg-[#7a2e94] text-white px-6 py-2.5 font-light tracking-wide shadow-md hover:shadow-lg transition-all"
            >
              <Link href="/contact">
          ...
          <button
            type="button"
            className="lg:hidden p-2 text-gray-600 hover:text-[#66257B] transition-colors"
            ...
            <nav className="flex flex-col space-y-4 px-4">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-sm font-light text-gray-700 hover:text-[#66257B] transition-colors tracking-wide py-2 border-b border-gray-100/50"
              ...
              <div className="flex items-center gap-4 pt-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-500 hover:text-[#66257B]"
                >
              ...
              <Button
                asChild
                className="bg-[#66257B] hover:bg-[#7a2e94] text-white w-full mt-4 font-light tracking-wide"
              >
