  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-gradient-to-r from-[#47145a] via-[#66257B] to-[#eb9142] shadow-lg">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 sm:h-24 lg:h-32 items-center justify-between gap-4">
          <Link
            href="/"
          ...
          <nav className="hidden lg:flex items-center gap-1 xl:gap-2">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="text-sm font-medium text-white/90 hover:text-white transition-all relative group px-3 py-2 rounded-lg hover:bg-white/20 backdrop-blur-sm"
              >
                {link.label}
          ...
          <div className="hidden lg:flex items-center gap-4">
            <div className="flex items-center gap-3">
              <a
                ...
                className="text-white/80 hover:text-white hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.8)] transition-all p-2 rounded-lg hover:bg-white/20"
          ...
          <button
            type="button"
            className="lg:hidden p-3 text-white hover:bg-white/20 rounded-lg transition-colors touch-manipulation min-w-[44px] min-h-[44px] flex items-center justify-center"
            ...
            <nav className="flex flex-col space-y-1">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-base text-white/90 hover:text-white hover:bg-white/10 transition-colors py-3 px-4 rounded-lg touch-manipulation min-h-[48px] flex items-center"
              ...
              <div className="flex items-center gap-3 pt-4 pb-2 px-4 border-t border-white/20">
                <a
                  href="https://www.instagram.com/drvrushni"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 text-white/80 hover:text-white hover:bg-white/10 rounded-lg transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center touch-manipulation"
                  aria-label="Instagram"
                >
              ...
              <div className="pt-2 px-4">
                <Button
                  asChild
                  className="bg-white hover:bg-white/90 w-full font-bold text-base min-h-[52px] touch-manipulation"
                >
                  <Link
                    href="/contact"
                    onClick={() => setMobileMenuOpen(false)}
                    ...
                    style={{ color: "#47145a" }}
                  >
                    <Phone className="w-5 h-5" style={{ color: "#47145a" }} />
