...
export function MedicalDisclaimer() {
  const disclaimerSchema = {
    ...
    "@type": "WarningOrRegulation",
    name: "Medical Disclaimer and Regulatory Information",
    text: "The information provided is for educational purposes only and should not be considered as medical advice. Consult with Dr. Vrushni Bhuta or a qualified healthcare professional before making any treatment decisions.",
    issuedBy: {
      "@type": "MedicalOrganization",
      name: "Dr. Vrushni's Women's Care & Fertility Clinic",
      medicalSpecialty: "Reproductive Medicine",
    },
    legislationIdentifier: "Medical Council of India Guidelines",
                  ...
                  <div className="flex-1 space-y-4">
                    ...
                    <div className="space-y-3 text-gray-700 leading-relaxed">
                      <p>
                        ...
                        educational purposes only and should not be considered as medical advice, diagnosis, or
                        treatment recommendation. Every individual's medical situation is unique.
                      </p>

                      <p>
                        <strong>Consult Your Healthcare Provider:</strong> Before making any decisions about fertility
                        treatments, medications, or procedures, please consult with Dr. Vrushni Bhuta or another
                        qualified healthcare professional. A thorough medical evaluation and personalized consultation
                        are essential to determine the most appropriate treatment plan for your specific circumstances.
                      </p>
                      ...
                      <p>
                        <strong>Medical Emergency:</strong> If you are experiencing a medical emergency, please call
                        your local emergency services immediately. This website is not intended for urgent medical
                        situations.
                      </p>
