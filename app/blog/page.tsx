...
export const metadata = {
  ...
  description: 'Read informative articles about fertility, IVF, pregnancy, and reproductive health from Dr Vrushni Bhuta.',
};
...
export default function BlogPage() {
  const blogPosts = [
    {
      ...
      excerpt: 'Learn everything you need to know about In Vitro Fertilisation, from the process to success rates and what to expect during treatment.',
      date: '2024-10-15',
      category: 'IVF',
    ...
    },
    {
      ...
      excerpt: 'Polycystic Ovary Syndrome affects many women. Learn how it impacts fertility and what treatment options are available.',
      date: '2024-10-05',
      category: 'Conditions',
    ...
    },
    {
      ...
      excerpt: 'A comprehensive guide to egg freezing, including who should consider it, the process, and success rates.',
      date: '2024-09-30',
    ...
    },
    {
      ...
      excerpt: 'Infertility affects men too. Understand the common causes and available treatments for male infertility.',
      date: '2024-09-25',
    ...
    },
    {
      ...
      excerpt: 'Essential tips and information to help you prepare physically and emotionally for your first IVF treatment.',
      date: '2024-09-20',
      category: 'IVF',
  ...
  const categories = ['All', 'IVF', 'Lifestyle', 'Conditions', 'Fertility Preservation', 'Male Fertility', 'Getting Pregnant'];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post, index) => (
              <Card key={index} className="border-2 border-gray-100 hover:border-[#eb9142] transition-all hover:shadow-xl group">
          ...
          <Card className="max-w-2xl mx-auto border-2 border-[#47145a]/10">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">
                Subscribe to our newsletter for the latest fertility tips, success stories, and updates from Dr Vrushni Bhuta
              </p>
