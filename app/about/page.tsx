  ...
  const personSchema = {
    ...
    hasCredential: [
      ...
      },
      {
        ...
        credentialCategory: "degree",
        educationalLevel: "Master's Degree",
        name: "M.R.M - Masters in Reproductive Medicine",
        recognizedBy: {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6 order-1 lg:order-2">
                ...
                <p className="text-xl text-gray-200 leading-relaxed">
                  With over a decade of expertise in Assisted Reproductive Techniques, Dr Vrushni Bhuta transforms
                  dreams of parenthood into reality through personalized, compassionate care.
                </p>
                <Button
                  asChild
                  size="lg"
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center mb-16">
              ...
              <p className="text-xl text-gray-700 leading-relaxed">
                Every family's path to parenthood is unique. Dr Vrushni Bhuta believes in providing personalized care
                that honors your individual journey while leveraging the latest advances in reproductive medicine.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                >
                  <div className="absolute top-0 right-0 text-8xl font-bold text-white/50 -mr-4 -mt-4">
                    {step.number}
                  </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Experience compassionate care and dedicated support at every step, ensuring you feel informed,
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <Card className="group relative overflow-hidden border-2 border-[#47145a]/10 hover:border-[#eb9142] transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                ...
                <CardContent className="p-8 relative z-10">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Inspired by the verse from the Bhagwad Gita, "Karmanye Vadhikaraste, Ma Phaleshou Kada Chana, Ma
                    Karma Phala Hetur Bhurmatey Sangostva Akarmani," Dr Vrushni focuses on providing the best possible
                    care, maintaining patient confidentiality, and upholding ethical standards and integrity in her
                    practice.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="group relative overflow-hidden border-2 border-[#47145a]/10 hover:border-[#eb9142] transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                ...
                <CardContent className="p-8 relative z-10">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Dr Vrushni believes that fertility is controlled by Mother Nature on a higher plane. She considers
                    all patients seeking treatment her soul families. With positive energy, advances in medical science
                    and technology, couples as well as individuals can bring new life into the world.
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        >
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="max-w-4xl mx-auto">
              <Card className="bg-white/10 backdrop-blur-sm border-2 border-white/10">
